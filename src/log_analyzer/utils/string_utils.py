...
def anonymize_text(
    text: str, patterns: Dict[str, str], salt: Optional[str] = None
) -> str:
...
def clean_control_chars(
    text: str, replacement: str = " ", keep_newlines: bool = True
) -> str:
