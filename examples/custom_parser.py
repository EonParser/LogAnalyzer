    ...
    def parse_line(self, line: str) -> Optional[LogEntry]:
        ...
        try:
            ...
            return LogEntry(
                ...
                metadata={"log_type": "application", "service": data["service"]},
            )
...
[2024-02-10 13:55:39] [ERROR] [DatabaseService] Connection failed - retries=3 host=db1
    ...
    try:
        ...
        pipeline.add_step(TransformStep("service_enrichment", enrich_service_info))

        # Add IP information enrichment for relevant logs
        pipeline.add_step(TransformStep("ip_enrichment", LogTransformer.enrich_ip_data))

        # Analyze logs
        results = analyzer.analyze_file(
            log_file, parser_name="custom", pipeline=pipeline
        )
