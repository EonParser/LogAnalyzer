...
from log_analyzer.parsers.apache import ApacheErrorLogParser, ApacheLogParser
...
class TestApacheErrorLogParser:
    ...
    def test_valid_error_format(self, error_parser):
        ...
        assert (
            entry.parsed_data["error_message"]
            == "File does not exist: /var/www/404.html"
        )
    ...
    def test_supports_error_format(self, error_parser):
        ...
        valid_line = (
            "[Wed Feb 14 15:48:31.999437 2024] [core:error] [pid 1234] Test message"
        )
        invalid_line = "Invalid log format"
