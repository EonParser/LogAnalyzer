...
class TestConfig:
    ...
    def test_default_config(self, config):
        ...
        assert config.get('parsing.chunk_size') == DEFAULT_CONFIG['parsing']['chunk_size']
        assert config.get('processing.max_workers') == DEFAULT_CONFIG['processing']['max_workers']
    ...
    def test_load_file(self, config, config_file):
        ...
        assert config.get('parsing.max_line_length') == DEFAULT_CONFIG['parsing']['max_line_length']
